...
export const courseList: Course[] = [
  ...
  { id: 3, subjectCode: 'MAD003', instructorName: 'Pantula', isAdmin: false, email: 'pantula@myscc.ca', marks: 10 , 'courseCost': 300, 'courseEnrollmentDate': new Date('2024-01-15'), imageUrl: 'https://commons.wikimedia.org/wiki/File:Python_image.jpg'},
  ...
  { id: 6, subjectCode: 'MAD006', instructorName: 'Takaki', isAdmin: false, email: 'takaki@myscc.ca', marks: 10, 'courseCost': 600, 'courseEnrollmentDate': new Date('2024-01-15'), imageUrl: 'https://commons.wikimedia.org/wiki/File:Python_image.jpg' }
];
